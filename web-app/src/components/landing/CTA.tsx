      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
          <Button 
            ...
            className="w-64 h-16 !bg-transparent text-white hover:!bg-black border-2 border-gray-200 hover:border-gray-900 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200"
          >
          ...
          <Button 
            ...
            className="w-64 h-16 bg-white text-gray-900 hover:!bg-black hover:text-white border-2 border-gray-200 hover:border-gray-900 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            <svg className="w-8 h-8 mr-3" viewBox="0 0 24 24" fill="currentColor">

...
export function FAQ({ openRegisterModal }: FAQProps) {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex justify-center mt-16">
            <button onClick={openRegisterModal} className="px-10 py-5 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 text-lg">
              지금 무료로 시작하기
            </button>
          </div>
        </div>
